							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{!! url('backend/chitiet') !!}"><img src="public/source/assets/dest/images/products/2.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{!! url('backend/chitiet') !!}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="{!! url('backend/chitiet') !!}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a  href="{!! url('backend/chitiet') !!}"	><img src="public/source/assets/dest/images/products/3.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
