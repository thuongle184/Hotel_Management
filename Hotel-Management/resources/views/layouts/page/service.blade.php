	...
	@section('slide')
	<section class="breadcumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url(public/thepalatin/img/bg-img/bg-5.jpg);">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-core-feature mb-100">
                        <div class="bg-thumbnail bg-img" style="background-image: url(public/thepalatin/img/bg-img/12.jpg);"></div>
                        <!-- Content -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-core-feature mb-100">
                        <div class="bg-thumbnail bg-img" style="background-image: url(public/thepalatin/img/bg-img/13.jpg);"></div>
                        <!-- Content -->
                        <div class="feature-content">
                            <i class="icon-sunset"></i>
                            <h3>Spa Center</h3>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-core-feature mb-100">
                        <div class="bg-thumbnail bg-img" style="background-image: url(public/thepalatin/img/bg-img/14.jpg);"></div>
                        <!-- Content -->
                        <div class="feature-content">
