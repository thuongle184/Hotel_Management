										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if($value -> promotion_price == 0)
					                                <span class="flash-sale">{!! $value -> unit_price !!} đ</span>
					                            @else
					                            	<span class="flash-del">{!! $value -> unit_price !!} đ</span>
					                            	<span class="flash-sale">{!! $value -> promotion_price !!} đ</span>
					                            @endif
											</p>
										</div>
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('AddtoCart',$sanpham->id)}}"><i class="fa fa-shopping-cart"></i></a>
