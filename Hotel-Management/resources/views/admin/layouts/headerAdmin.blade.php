                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Manage Room Size<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Manage Equipments<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Manage indentification type<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Manage online flatform<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                                                <a href="{!! url('userTypes/create') !!}">Add new</a>
                                            </li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Manage Booking purpose<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> Manage Dish Type<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
