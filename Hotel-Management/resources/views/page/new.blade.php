	@extends('master')
	@section('slide')
	<section class="breadcumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url(public/thepalatin/img/bg-img/bg-7.jpg);">
                    ...
                    <div class="palatin-blog-posts">
                        ...
                        <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <div class="blog-post-thumb">
                                <img src="public/thepalatin/img/blog-img/1.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                        ...
                        <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="300ms">
                            <!-- Post Thumb -->
                            <div class="blog-post-thumb">
                                <img src="public/thepalatin/img/blog-img/2.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <!-- Post Date-->
                        ...
                        <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="500ms">
                            <!-- Post Thumb -->
                            <div class="blog-post-thumb">
                                <img src="public/thepalatin/img/blog-img/3.jpg" alt="">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <!-- Post Date-->
