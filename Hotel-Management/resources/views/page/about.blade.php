	@extends('master')
	@section('slide')
	<section class="breadcumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url(public/thepalatin/img/bg-img/bg-2.jpg);">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail mb-100">
                        <img src="public/thepalatin/img/bg-img/2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="our-milestones section-padding-100-0 bg-img bg-overlay bg-fixed" style="background-image: url(public/thepalatin/img/bg-img/bg-4.jpg);">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-hotel-info mb-100">
                        ...
                        <div class="hotel-img">
                            <img src="public/thepalatin/img/bg-img/3.jpg" alt="">
                        </div>
                    </div>
                </div>
                <!-- Single Hotel Info -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-hotel-info mb-100">
                        ...
                        <div class="hotel-img">
                            <img src="public/thepalatin/img/bg-img/10.jpg" alt="">
                        </div>
                    </div>
                </div>
                <!-- Single Hotel Info -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-hotel-info mb-100">
                        ...
                        <div class="hotel-img">
                            <img src="public/thepalatin/img/bg-img/11.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="testimonial-area section-padding-100 bg-img" style="background-image: url(public/thepalatin/img/core-img/pattern.png);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="testimonial-content">
                        ...
                        <div class="testimonial-slides owl-carousel">
                            ...
                            <div class="single-testimonial">
                                ...
                                <img src="public/thepalatin/img/core-img/trip.png" alt="">
                            </div>
