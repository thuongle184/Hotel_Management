...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 style="color: #7a09ff;" class="page-header">Add Dish Type</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        @if($errors->any())
    ...
    @endif
    <form   action="{!! url('/dishTypes') !!}" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal registration-form" >
        {{ csrf_field() }}
