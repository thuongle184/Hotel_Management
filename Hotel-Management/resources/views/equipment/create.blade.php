...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 style="color: #7a09ff;" class="page-header">Add equipment</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        @if($errors->any())
    ...
    <form   action="{!! url('/equipment') !!}" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal registration-form" >
        ...
        <div class="row">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
             <input  id="cach" value="{{old('label')}}" type="text" class="form-control" name="label" placeholder="Enter equipment name">
         </div>
     </div>
     <center>
